...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/src/main/java");//设置生成的文件输出位置
        gc.setAuthor("hmx");
        gc.setOpen(false);
        ...
        strategy.setInclude("cutover_Information","important_Security_Incident");//要生成的表名，想要生成哪个表的代码就填表名，可传多个参数，","隔开
